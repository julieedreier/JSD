...
async function getPost(pageValue) {
    ...
    const post = await fetch(`https://my37wf9g.api.sanity.io/v1/data/query/production?query=*[slug.current == "${pageValue}"]`);
...
async function getPosts() {
    ...
    const posts =  await fetch(`https://my37wf9g.api.sanity.io/v1/data/query/production?query=*`);
    ['_type' == "post"]
